...
plt.imshow(vx.data[1], interpolation='bicubic', vmin = -0.01, vmax = 0.01)
plt.xlabel("y")
plt.ylabel("x")
plt.colorbar()
plt.savefig("Figures/2D_Elastic/vx_dev", dpi=200)
plt.show()

plt.imshow(vy.data[1], interpolation='bicubic', vmin = -0.01, vmax = 0.01)
plt.xlabel("y")
plt.ylabel("x")
plt.colorbar()
plt.savefig("Figures/2D_Elastic/vy_dev", dpi=200)
plt.show()

plt.imshow(txx.data[1], interpolation='bicubic', vmin = -20., vmax = 20.)
plt.xlabel("y")
plt.ylabel("x")
plt.colorbar()
plt.savefig("Figures/2D_Elastic/txx_dev", dpi=200)
plt.show()

plt.imshow(tyy.data[1], interpolation='bicubic', vmin = -20., vmax = 20.)
plt.xlabel("y")
plt.ylabel("x")
plt.colorbar()
plt.savefig("Figures/2D_Elastic/tyy_dev", dpi=200)
plt.show()

plt.imshow(txy.data[1], interpolation='bicubic', vmin = -20., vmax = 20.)
plt.xlabel("y")
plt.ylabel("x")
plt.colorbar()
plt.savefig("Figures/2D_Elastic/txy_dev", dpi=200)
plt.show()